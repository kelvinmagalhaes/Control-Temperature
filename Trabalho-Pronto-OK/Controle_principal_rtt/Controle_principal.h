...
#ifndef RTW_HEADER_Controle_principal_h_
#define RTW_HEADER_Controle_principal_h_
#include <float.h>
#include <string.h>
#include <stddef.h>
#ifndef Controle_principal_COMMON_INCLUDES_
# define Controle_principal_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Controle_principal_COMMON_INCLUDES_ */

#include "Controle_principal_types.h"
...
struct P_Controle_principal_T_ {
...
struct tag_RTM_Controle_principal_T {
   ...
   */
  struct {
    X_Controle_principal_T *contStates;
...
extern P_Controle_principal_T Controle_principal_P;

/* Block signals (auto storage) */
extern B_Controle_principal_T Controle_principal_B;

/* Continuous states (auto storage) */
extern X_Controle_principal_T Controle_principal_X;

/* Block states (auto storage) */
extern DW_Controle_principal_T Controle_principal_DW;

/* Model entry point functions */
extern void Controle_principal_initialize(void);
extern void Controle_principal_output(void);
extern void Controle_principal_update(void);
extern void Controle_principal_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Controle_principal_T *const Controle_principal_M;
 ...
 *
 * '<Root>' : 'Controle_principal'
 * '<S1>'   : 'Controle_principal/Medida'
 * '<S2>'   : 'Controle_principal/P '
 * '<S3>'   : 'Controle_principal/PI '
 * '<S4>'   : 'Controle_principal/PID'
 * '<S5>'   : 'Controle_principal/PWM1'
 * '<S6>'   : 'Controle_principal/PWM2'
 * '<S7>'   : 'Controle_principal/PWM3'
 */
#endif                                 /* RTW_HEADER_Controle_principal_h_ */
