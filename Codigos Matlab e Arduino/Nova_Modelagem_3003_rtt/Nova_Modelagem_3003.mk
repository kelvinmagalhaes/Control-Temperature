...
# Autogenerated on: 13-Apr-2019 20:21:53
# Model: NOVA_MODELAGEM_3003
# MyTemplate
# File name: Nova_Modelagem_3003.mk
# Template: gmake 
...
MODEL_NAME := Nova_Modelagem_3003
...
MATLAB_ROOT_ABSOLUTE := D:\Program Files\MATLAB\MATLAB Production Server\R2015a\#MATLAB_ROOT_ABSOLUTE_END
...
ifneq (.a,$(strip $(TARGET_EXT)))
SOURCE_FILES := $(call FORMAT_PATH,.\HardwareSerial.cpp) $(call FORMAT_PATH,.\IPAddress.cpp) $(call FORMAT_PATH,.\Print.cpp) $(call FORMAT_PATH,.\WInterrupts.c) $(call FORMAT_PATH,.\WMath.cpp) $(call FORMAT_PATH,.\WString.cpp) $(call FORMAT_PATH,.\new.cpp) $(call FORMAT_PATH,.\wiring.c) $(call FORMAT_PATH,.\wiring_analog.c) $(call FORMAT_PATH,.\wiring_digital.c) $(call FORMAT_PATH,.\rtiostream_serial.cpp) $(call FORMAT_PATH,.\io_wrappers.cpp) $(call FORMAT_PATH,.\Nova_Modelagem_3003.c) $(call FORMAT_PATH,.\Nova_Modelagem_3003_data.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\rtGetInf.c) $(call FORMAT_PATH,.\rtGetNaN.c) $(call FORMAT_PATH,.\rt_nonfinite.c) $(call FORMAT_PATH,.\ext_svr.c) $(call FORMAT_PATH,.\ext_work.c) $(call FORMAT_PATH,.\updown.c) $(call FORMAT_PATH,.\ext_serial_pkt.c) $(call FORMAT_PATH,.\ext_svr_serial_transport.c) $(call FORMAT_PATH,.\rtiostream_serial_interface.c) $(call FORMAT_PATH,.\rtiostream_utils.c)
else
SOURCE_FILES := $(call FORMAT_PATH,.\HardwareSerial.cpp) $(call FORMAT_PATH,.\IPAddress.cpp) $(call FORMAT_PATH,.\Print.cpp) $(call FORMAT_PATH,.\WInterrupts.c) $(call FORMAT_PATH,.\WMath.cpp) $(call FORMAT_PATH,.\WString.cpp) $(call FORMAT_PATH,.\new.cpp) $(call FORMAT_PATH,.\wiring.c) $(call FORMAT_PATH,.\wiring_analog.c) $(call FORMAT_PATH,.\wiring_digital.c) $(call FORMAT_PATH,.\rtiostream_serial.cpp) $(call FORMAT_PATH,.\io_wrappers.cpp) $(call FORMAT_PATH,.\Nova_Modelagem_3003.c) $(call FORMAT_PATH,.\Nova_Modelagem_3003_data.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\rtGetInf.c) $(call FORMAT_PATH,.\rtGetNaN.c) $(call FORMAT_PATH,.\rt_nonfinite.c) $(call FORMAT_PATH,.\ext_svr.c) $(call FORMAT_PATH,.\ext_work.c) $(call FORMAT_PATH,.\updown.c) $(call FORMAT_PATH,.\ext_serial_pkt.c) $(call FORMAT_PATH,.\ext_svr_serial_transport.c) $(call FORMAT_PATH,.\rtiostream_serial_interface.c) $(call FORMAT_PATH,.\rtiostream_utils.c)
endif

HEADER_FILES := $(call FORMAT_PATH,C:\MATLAB\SupportPackages\R2015a\arduino-1.0.5\hardware\arduino\cores\arduino\HardwareSerial.h) $(call FORMAT_PATH,C:\MATLAB\SupportPackages\R2015a\arduino-1.0.5\hardware\arduino\cores\arduino\IPAddress.h) $(call FORMAT_PATH,C:\MATLAB\SupportPackages\R2015a\arduino-1.0.5\hardware\arduino\cores\arduino\Print.h) $(call FORMAT_PATH,C:\MATLAB\SupportPackages\R2015a\arduino-1.0.5\hardware\arduino\cores\arduino\WString.h) $(call FORMAT_PATH,C:\MATLAB\SupportPackages\R2015a\arduino-1.0.5\hardware\arduino\cores\arduino\new.h) $(call FORMAT_PATH,.\Nova_Modelagem_3003.h) $(call FORMAT_PATH,.\rtGetInf.h) $(call FORMAT_PATH,.\rtGetNaN.h) $(call FORMAT_PATH,.\rt_nonfinite.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\Program Files\MATLAB\MATLAB Production Server\R2015a\rtw\c\src\ext_mode\common\ext_svr.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\Program Files\MATLAB\MATLAB Production Server\R2015a\rtw\c\src\ext_mode\common\ext_work.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\Program Files\MATLAB\MATLAB Production Server\R2015a\rtw\c\src\ext_mode\common\updown.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\Program Files\MATLAB\MATLAB Production Server\R2015a\rtw\c\src\ext_mode\serial\ext_serial_pkt.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\Program Files\MATLAB\MATLAB Production Server\R2015a\toolbox\coder\rtiostream\src\utils\rtiostream_utils.h)
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2015a/arduinobase/toolbox/realtime/targets/arduino/include" -I"C:/MATLAB/SupportPackages/R2015a/arduinobase/toolbox/realtime/targets/arduino/blocks/sfcn/include" -I"D:/Dados/Engenharia/8 Semestre/Sistema de Controle 1/Projeto/Codigos Matlab e Arduino/Nova_Modelagem_3003_rtt" -I"D:/Dados/Engenharia/8 Semestre/Sistema de Controle 1/Projeto/Codigos Matlab e Arduino" -I"D:/Dados/Engenharia/8 Semestre/Sistema de Controle 1/Projeto" -I"D:/Program Files/MATLAB/MATLAB Production Server/R2015a/extern/include" -I"D:/Program Files/MATLAB/MATLAB Production Server/R2015a/simulink/include" -I"D:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src" -I"D:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src/ext_mode/common" -I"D:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/ert" -I"D:/Program Files/MATLAB/MATLAB Production Server/R2015a/toolbox/coder/rtiostream/src/utils" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/cores/arduino" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/variants/mega" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.0.5/libraries/Servo" -I"D:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src/ext_mode/serial" -I"C:/MATLAB/SupportPackages/R2015a/arduino/toolbox/realtime/targets/arduinomega2560/src" -mmcu=atmega2560 -ffunction-sections -fdata-sections -std=gnu99 -Wall -Wstrict-prototypes -g -Os -D"MODEL=Nova_Modelagem_3003" -D"NUMST=2" -D"NCSTATES=8" -D"HAVESTDIO=" -D"ON_TARGET_WAIT_FOR_START=1" -D"ONESTEPFCN=0" -D"EXT_MODE=1" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=1" -D"F_CPU=16000000" -D"ARDUINO=105" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"_ROTH_MEGA2560_=" -D"_RTT_NUMSERVOS_=0" -D"EXIT_FAILURE=1" -D"EXTMODE_DISABLEPRINTF=" -D"EXTMODE_DISABLETESTING=" -D"EXTMODE_DISABLE_ARGS_PROCESSING=1"
...
POSTBUILD_ARGS := -O ihex -R .eeprom $(TARGET)  Nova_Modelagem_3003.hex
